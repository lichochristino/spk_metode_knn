SPK (Sistem Pendukung Keputusan) metode KNN (K-Nearest Neighbors) adalah salah satu metode yang dapat digunakan dalam trading untuk membantu mengambil keputusan berdasarkan data historis.
